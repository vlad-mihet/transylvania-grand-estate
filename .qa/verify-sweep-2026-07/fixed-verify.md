...
|---|---|---|---|---|
| BUG-101 | Minor | lint clean across 4 apps + CI gate | Phase 1 `pnpm lint:all` | pending |
...
| BUG-118 | Critical | people/team page functional | Phase 2 UI | pending |
...
| BUG-128 | Minor | fresh /new form not dirty | Phase 2 UI | pending |
