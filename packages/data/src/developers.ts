...
export const developers: Developer[] = [
  {
    ...
    description: {
      ...
      ro: "Verdalis Residence este cel mai important dezvoltator de lux sustenabil din Cluj-Napoca, cunoscut pentru integrarea practicilor de constructii verzi cu designul rezidential de inalta clasa. Proiectele lor prezinta constructii eficiente energetic, sisteme smart home si spatii verzi generoase.",
    },
    shortDescription: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Carpathia Imobiliare este unul dintre cei mai consacrati dezvoltatori rezidentiali din Romania, cu peste 15 ani de experienta in livrarea comunitatilor rezidentiale premium din Transilvania. Cunoscuti pentru atentia la detalii si angajamentul fata de materialele de calitate, Carpathia a livrat peste 3.000 de locuinte in Brasov, Sibiu si Cluj-Napoca.",
    },
    shortDescription: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Atrium Boutique se specializeaza in dezvoltari rezidentiale boutique in Timisoara, creand comunitati intime cu accent pe excelenta arhitecturala si facilitati premium. Fiecare proiect este limitat la un numar mic de unitati, asigurand exclusivitate si atentie personalizata la fiecare detaliu.",
    },
    shortDescription: {
  ...
  },
  {
    ...
    description: {
      ...
      ro: "Dacia Construct & Dezvoltare este un dezvoltator imobiliar roman listat la bursa, cu un accent puternic pe proiecte rezidentiale sustenabile de mare amploare. Cu operatiuni in principalele orase din Romania, Dacia Construct aduce calitate de grad institutional dezvoltarilor rezidentiale, cu facilitati comunitare integrate si certificari verzi.",
    },
    shortDescription: {
