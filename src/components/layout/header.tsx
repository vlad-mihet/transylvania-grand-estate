    ...
    >
      ...
      <div
        className={cn(
          ...
          isScrolled
            ? "h-0 opacity-0"
            : "h-8 opacity-100 border-b border-copper/5"
        )}
      >
          ...
          <div className="flex items-center justify-between h-8">
            ...
            <div className="flex items-center gap-6">
              <a
                ...
                className="flex items-center gap-1.5 text-[11px] text-cream-muted/70 hover:text-copper tracking-[0.1em] uppercase transition-colors duration-500 ease-luxury"
              >
      ...
      >
        ...
        <MegaMenu isOpen={activeMenu === "developers"} onClose={closeMenuImmediate}>
          <div className="grid grid-cols-2 gap-16">
            <MegaMenuColumn title={t("developers")}>
              <MegaMenuLink href="/developers" onClick={closeMenuImmediate}>
                {t("viewAllDevelopers")}
              </MegaMenuLink>
            </MegaMenuColumn>
